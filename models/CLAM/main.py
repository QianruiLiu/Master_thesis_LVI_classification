...
parser.add_argument('--task', type=str, choices=['task_lvi_binary'])
...
if args.task == 'task_lvi_binary':
    args.n_classes=2
    dataset = Generic_MIL_Dataset(csv_path = './clam_lvi_labels.csv',
                            data_dir= os.path.join(args.data_root_dir, 'LVI'),
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
